...
def write_schema(database_fn):
    ...
    with open('wkst-nuclear.json', 'w', encoding='utf-8') as fid:
...
# Also accounts for the weird spacing.  content/games/databases/game-nuclear.py is the master copy
# pylint: disable=bad-indentation
index = 5 * NUM_MEMBERS
if __name__ == "__main__":
            database_fn = 'wkst-nuclear.sqlite'

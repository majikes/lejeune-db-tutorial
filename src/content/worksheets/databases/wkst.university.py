...
DATABASES =['wkst.university1.sqlite', 'wkst.university2.sqlite']
conns = []
for db in DATABASES:
...
cursor.execute("""insert into instructor values ('31601', 'Majikes', 'Comp. Sci.', '95000')""")
cursor.execute("""insert into course values('COMP-421', 'Databases and Files', 'Comp. Sci.', 3)""")
...
cursor.execute("""insert into section (course_id, sec_id, semester, building, room_number, time_slot_id)
                                values('CS-190', '1', 'Spring', 'Murphey', '116', 'A')""")
cursor.execute("""insert into teaches (ID, course_id, sec_id, semester, year)
                                values('31601', 'CS-190', 1, 'Spring', 2017)""")
cursor.execute("""insert into teaches (ID, course_id, sec_id, semester, year)
                                values('31601', 'CS-319', 1, 'Spring', 2018)""")
cursor.execute("""insert into teaches (ID, course_id, sec_id, semester, year)
                               values('31601', 'COMP-421', 1, 'Fall', 2023)""")
cursor.execute("""insert into teaches (ID, course_id, sec_id, semester, year)
                               values('31601', 'COMP-116', 1, 'Fall', 2023)""")
cursor.execute("""insert into teaches (ID, course_id, sec_id, semester, year)
                              values('31601', 'CS-101', 1, 'Fall', '2017')""")
cursor.execute("""insert into teaches (ID, course_id, sec_id, semester, year)
                              values('31601', 'CS-315', 1, 'Spring', '2018')""")
cursor.execute("""insert into teaches (ID, course_id, sec_id, semester, year)
                              values('31601', 'CS-347', 1, 'Fall', '2017')""")

# Put Galileo in a second database
cursor.execute("""insert into instructor values ('1564', 'Galileo Galilei', 'Physics', '96000')""")
cursor.execute("""insert into instructor values ('1930', 'Fred Brooks, Jr', 'Comp. Sci.', '96000')""")
